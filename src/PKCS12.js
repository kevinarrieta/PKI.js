...
import { getAlgorithmParameters, getRandomValues, setEngine } from "./common";
...
//endregion 
//*********************************************************************************
export function openSSLLike(password, inputAlgorithm, inputHashAlgorithm = "SHA-256")
{
...
//*********************************************************************************
export function windowsLike(password, inputAlgorithm, inputHashAlgorithm = "SHA-256")
{
	//region Initial variables
	let sequence = Promise.resolve();
...
//*********************************************************************************
export function parsePKCS12(buffer, password)
{
	//region Initial variables
	let sequence = Promise.resolve();
